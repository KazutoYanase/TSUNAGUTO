...
<head>
    ...
    <meta property="og:image" content="https://tsunaguto.jp/common/images/ogp-a1.jpg">
    ...
    <meta name="twitter:image" content="https://tsunaguto.jp/common/images/ogp-a1.jpg">
...
<!-- A-1 -->
    <section class="ochart__result_page" id="ochart__result__a1">
        ...
        <div class="ochart__result__btn"><a href="https://tsunaguto.jp/lineup_bancha.php">このお茶の詳しい情報はこちら</a></div>
        <div class="ochart__ochart_rtbtn">
            <a href="./ochart.php">
                お茶スタイル診断をはじめる
            </a>
        ...
        <section class="lineup__box ochart__lineup fade">
            <div class="lineup__box__inner">
                ...
                <div class="lineup__list lineup__list__single">
                    <ul>
                        <li class="fade">
                            <a href="https://tsunaguto.jp/lineup_kamairi.php">
                        ...
                        <li class="fade">
                            <a href="https://tsunaguto.jp/lineup_black.php">
                        ...
                        <li class="fade">
                            <a href="https://tsunaguto.jp/lineup_oolong.php">
